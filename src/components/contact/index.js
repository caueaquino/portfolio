    ...
    render() {
        return (
            <section id="contact">
                ...
                <div id="social-media">
                    <a href="https://www.facebook.com/caue.nogueira.3" title="facebook" target="_blank" rel="noopener noreferrer">
                        <svg version="1.1" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px"
                        width="80" height="80" viewBox="0 0 60.734 60.733" enable-background="new 0 0 60.734 60.733" className="pic">
